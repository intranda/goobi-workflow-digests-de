...
![Beispiel für die Suche nach Fertigstellungsdatum](../.gitbook/assets/2102_filter_steps_de.png)
...
​
Durch die Umstellung auf aktuelle Technologien (CDI, JSF 2.3) können nun in Goobi worflow Websockets eingesetzt werden. Diese ermöglichen eine performante bidirektionale Kommunikation zwischen Server und Browser. Dadurch ist es uns nun möglich, von der Serverseite aus Nachrichten zum Nutzer zu schicken.
Ein erster Anwendungsfall, wo dieses Anwendung findet sind die folgenden zwei Bereiche:
...
![Anzeige von administrativen Warnmeldungen bei den Nutzern](../.gitbook/assets/2102_websockets_de.png)
...
![Anzeige von Aufgaben, die bereits abgeschlossen wurden auf dem Dashboard](../.gitbook/assets/2102_dashboard_de.png)
...
![Erweiterte Möglichkeiten für die Anpassung der Reihenfolge von Arbeitsschritten](../.gitbook/assets/2102_taskorder1_de.png)
...
![Einfügen von neuen Aufgaben mit erweiterter Logik für die Reihenfolgenposition](../.gitbook/assets/2102_taskorder2_de.png)
...
![Neues GoobiScript für das Einfügen von neuen Aufgaben für viele Vorgänge](../.gitbook/assets/2102_taskorder3_de.png)
