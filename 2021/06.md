...
![Konvertierung von METS zu LIDO und zurück](../.gitbook/assets/2106_mets_lido.png)
...
## Anpassungen an der Nutzbarkeit von IIIF-URLs in Scriptaufrufen

Vor kurzem hatten wir den sogenannten Variablen-Replacer dahingehend erweitert, dass dieser nun auch IIIF-URL für die zugehörigen Bilder eines Vorgangs in Scriptaufrufen erlaubt. Hier mussten wir noch einmal etwas nachkorrigieren, damit das Encoding der URLs für die jeweiligen Anwendungsfälle passt.
...
![Die Vokabularverwaltung von Goobi findet immer mehr Einsatz](../.gitbook/assets/2106_vocabulary_de.png)
...
![Accessibility ist wichtiger als viele denken!](../.gitbook/assets/2106_wcag.png)
...
![Auszug aus der Konsole nach dem Kompilieren von Goobi workflow mit Java 11](../.gitbook/assets/2106_java11.png)
...
![In der Standard-Installation ist das JWT-Secret noch auskommentiert und kann inidividuell konfiguriert werden](../.gitbook/assets/2106_jwt1.png)
...
![Einstellung des Standard-Exports für METS-Dateien ohne Berücksichtigung des MIME-Types](../.gitbook/assets/2106_export2_de.png)
...
![Einstellung des Standard-Exports für METS-Dateien für die Berücksichtigung des MIME-Types](../.gitbook/assets/2106_export1_de.png)
...
![Generierung von Gettern und Settern durch Lombok](../.gitbook/assets/2106_lombok.png)
...
![Metadatengruppen lassen sich nun vollständig duplizieren](../.gitbook/assets/2106_metadatagroups_de.png)
