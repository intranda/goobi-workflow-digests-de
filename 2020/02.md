...
![Zoom beibehalten](../.gitbook/assets/2002\_mets\_zoom.png)
...
![Italienische Oberfläche](../.gitbook/assets/2002\_italian.png)
...
![Der bisherige Button zum Drucken erzeugt nun die PDF-Datei](../.gitbook/assets/2002\_mets\_pdf1.png)

Darüber hinaus ist diese Funktion auch direkt aus dem Menü der Vorgangsliste für jeden Vorgang zugänglich:

![Herunterladen der PDF-Datei aus der Vorgangsliste](../.gitbook/assets/2002\_mets\_pdf2.png)
...
![Beispiel für eine PDF-Datei mit Strukturinformationen und Metadaten](../.gitbook/assets/2002\_mets\_pdf3.png)
...
![Beispiel eines Laufzettels mit hebräischen Zeichen](../.gitbook/assets/2002\_hebrew\_docket.png)
...
![Intgration des Plugins in den Workflow](../.gitbook/assets/2002\_plugin\_image\_validation.png)
...
https://docs.intranda.com/goobi-workflow-plugins-de/step-plugins/intranda\_step\_jhove-validation
{% endembed %}
...
![Dokumentation des Variablensystems von Goobi workflow](../.gitbook/assets/2002\_documentation\_variables.png)
...
https://docs.intranda.com/goobi-workflow-plugins-de/step-plugins/intranda\_step-rename-files
{% endembed %}
...
![Bedienung des Barcode-Generators in Goobi workflow](../.gitbook/assets/2002\_barcodes1.png)

Die Barcodes können aussehen wie dieses Beispiel:

![Ergebnis einer beispielhaften Barcode-Generierung](../.gitbook/assets/2002\_barcodes2.png)
